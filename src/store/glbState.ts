...
const GLB_STRUCTURE = {
  "Fifth Street Building": {
    "Ground Floor": ["Club 76", "F - LOUNGE", "F-10", "F-15", "F-20", "F-25", "F-30", "F-35", "F-40", "F-50", "F-60", "F-70", "FG - Library", "FG - Restroom"],
  ...
  "Tower Building": {
    "Main Floor": ["T-100", "T-110", "T-200", "T-210", "T-220", "T-230", "T-300", "T-310", "T-320", "T-340", "T-400", "T-410", "T-420", "T-430", "T-450", "T-500", "T-530", "T-550", "T-600", "T-700", "T-800", "T-900", "T-950", "T-1000", "T-1100", "T-1200"]
  }
};
